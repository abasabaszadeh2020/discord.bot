...
module.exports ={
    ...
    run : async(client , message) =>{
        ...
        .setDescription('Link Invite : https://discord.com/api/oauth2/authorize?client_id=823646509001080902&permissions=8&scope=bot')
        .setColor('#00050e')
        .setFooter(`Bot Developed By Marexᵛⁱᵖᵉʳ#2528`)
